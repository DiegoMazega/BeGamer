create table tb_game (id int8 generated by default as identity, platform int4, title varchar(255), genre_id int4, primary key (id));
create table tb_genre (id int4 generated by default as identity, name varchar(255), primary key (id));
create table tb_record (id int4 generated by default as identity, age int4, moment timestamp, name varchar(255), game_id int8, primary key (id));
